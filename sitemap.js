         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="Clique aqui para mostrar todas as postagens da categoria \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'TÍTULO DA POSTAGEM';
   var tocTool1 = 'Clique para classificar por título';
   var tocHead2 = 'DATA DA POSTAGEM';
   var tocTool2 = 'Clique para classificar por data';
   var tocHead3 = 'CATEGORIAS';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (Descendente)';
      tocTool2 += ' (Os mais novos primeiro)';
   }
   if (sortBy == "titledesc") { 
      tocTool1 += ' (Ascendente)';
      tocTool2 += ' (Os mais novos primeiro)';
   ...
   if (sortBy == "datenewest") { 
      tocTool1 += ' (Ascendente)';
      tocTool2 += ' (Mais velhos primeiro)';
   }
   if (postFilter != '') {
      tocTool3 = 'Clique para mostrar todas as postagens';
   }
   tocTable += '<table>';
   tocTable += '<tr>';
